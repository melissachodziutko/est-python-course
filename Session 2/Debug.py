...
def main():
    ...
    #insert your best friend's name, child's name, spouse's name, whatever you'd like here and have it print out
    name2 = ""
    print("Hello, my best friend's name is ", name)
    
    #put your age here... whether it's true or not i'll never know ;)
    age = 
